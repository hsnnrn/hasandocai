 ...
 */
export function generatePKCEPair(verifierLength: number = 128): PKCEPair {
 ...
 */
export function buildTokenExchangeData(
  code: string,
  redirectUri: string,
  clientId: string,
  codeVerifier: string
 ...
 */
export function buildRefreshTokenData(
  refreshToken: string,
  clientId: string
): URLSearchParams {
  return new URLSearchParams({
 ...
 */
export function validatePKCEParameters(codeVerifier: string, codeChallenge: string): boolean {
  try {
 ...
 */
export const SUPABASE_OAUTH_ENDPOINTS = {
